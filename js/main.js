...
var mainState = {
  ...
  create: function () {
    ...
    //This is where we'll set up the game asets from scratch
  ...
  update: function () {
  //This fuction is called 60 times a second
  //It contains the games lofic nd all timer related actions
  ...
  addOnePipe: function (x,y) {
   ...
   //Move the pipes to the lest of the screen
